...
export default function LegendPanel() {
  ...
  return (
    <div className="absolute bottom-6 right-4 md:right-6 z-20 w-48 md:w-64 flex flex-col pointer-events-auto transition-all duration-300 shadow-xl rounded-t-lg bg-white overflow-hidden">
