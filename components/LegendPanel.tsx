...
export default function LegendPanel() {
  ...
  return (
    <div className="absolute bottom-6 md:bottom-auto md:top-32 right-4 md:right-4 bg-white/95 backdrop-blur rounded-lg shadow-xl border border-gray-200 z-10 w-56 md:w-64 overflow-hidden transition-all">
      <div 
