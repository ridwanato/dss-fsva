      ...
      <div className="max-w-4xl mx-auto px-6 space-y-6">
        ...
        <div className="glass-card p-8 rounded-3xl border border-green-100/50 shadow-xl bg-white/90 backdrop-blur-md">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-black text-slate-800 leading-tight">Tentang Aplikasi FSVA</h1>
              <p className="text-sm text-slate-500 font-medium">Food Security and Vulnerability Atlas</p>
            </div>
          </div>
          
          <div className="space-y-6 text-sm md:text-base text-slate-650 leading-relaxed">
            <p>
              <strong>Food Security and Vulnerability Atlas (FSVA)</strong> atau Peta Ketahanan dan Kerentanan Pangan merupakan instrumen penting untuk memetakan kondisi ketahanan dan kerentanan pangan suatu wilayah secara spasial hingga tingkat desa/kelurahan (Kabupaten/Kota) dan tingkat kecamatan (Provinsi).
            </p>
            <p>
              Platform ini dibangun sebagai sistem otomasi untuk memproses kalkulasi dan menyajikan visualisasi peta choropleth secara akurat. Metode perhitungan dan klasifikasi prioritas didasarkan secara penuh pada <strong>Petunjuk Teknis Penyusunan Peta Ketahanan dan Kerentanan Pangan (FSVA) Badan Pangan Nasional Tahun 2025 (Juknis No. 301.2/2025 & Pemutakhiran 2026)</strong>.
            </p>
            <p>
            ...
            <p>
              Dengan adanya pemetaan spasial ini, pemerintah daerah dan pemangku kebijakan dapat mengidentifikasi lokasi intervensi program ketahanan pangan secara lebih presisi dan efisien (target intervensi difokuskan pada wilayah Prioritas 1-3).
            </p>
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row justify-end gap-3">
            <Link href="/" className="px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 transition text-center">
              Kembali ke Beranda
            </Link>
            <Link href="/metodologi-fsva" className="px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-slate-700 bg-slate-200/80 hover:bg-slate-200 transition text-center">
              Pernyataan Independensi &amp; Metodologi
            </Link>
            <Link href="/map" className="px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-white bg-emerald-600 hover:bg-emerald-700 transition shadow-sm text-center">
